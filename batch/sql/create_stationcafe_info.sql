...
WITH tmp1 AS (
    SELECT
        ...
        target_station_name,
        search_name
    FROM :schema.tmp_add_total_check
    WHERE total_check_flag = 1
...
tmp2 AS (
    SELECT
        ...
        search_lon,
        target_station_name,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id =  1) THEN 1 ELSE 0 END AS tmp_cflag01,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id =  2) THEN 1 ELSE 0 END AS tmp_cflag02,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id =  3) THEN 1 ELSE 0 END AS tmp_cflag03,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id =  4) THEN 1 ELSE 0 END AS tmp_cflag04,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id =  5) THEN 1 ELSE 0 END AS tmp_cflag05,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id =  6) THEN 1 ELSE 0 END AS tmp_cflag06,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id =  7) THEN 1 ELSE 0 END AS tmp_cflag07,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id =  8) THEN 1 ELSE 0 END AS tmp_cflag08,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id =  9) THEN 1 ELSE 0 END AS tmp_cflag09,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id = 10) THEN 1 ELSE 0 END AS tmp_cflag10,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id = 11) THEN 1 ELSE 0 END AS tmp_cflag11,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id = 12) THEN 1 ELSE 0 END AS tmp_cflag12,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id = 13) THEN 1 ELSE 0 END AS tmp_cflag13,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id = 14) THEN 1 ELSE 0 END AS tmp_cflag14,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id = 15) THEN 1 ELSE 0 END AS tmp_cflag15,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id = 16) THEN 1 ELSE 0 END AS tmp_cflag16,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id = 17) THEN 1 ELSE 0 END AS tmp_cflag17,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id = 18) THEN 1 ELSE 0 END AS tmp_cflag18,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id = 19) THEN 1 ELSE 0 END AS tmp_cflag19,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id = 20) THEN 1 ELSE 0 END AS tmp_cflag20,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id = 21) THEN 1 ELSE 0 END AS tmp_cflag21,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id = 22) THEN 1 ELSE 0 END AS tmp_cflag22,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id = 23) THEN 1 ELSE 0 END AS tmp_cflag23,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id = 24) THEN 1 ELSE 0 END AS tmp_cflag24,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id = 25) THEN 1 ELSE 0 END AS tmp_cflag25,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id = 26) THEN 1 ELSE 0 END AS tmp_cflag26,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id = 27) THEN 1 ELSE 0 END AS tmp_cflag27,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id = 28) THEN 1 ELSE 0 END AS tmp_cflag28,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id = 29) THEN 1 ELSE 0 END AS tmp_cflag29,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id = 30) THEN 1 ELSE 0 END AS tmp_cflag30,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id = 31) THEN 1 ELSE 0 END AS tmp_cflag31,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id = 32) THEN 1 ELSE 0 END AS tmp_cflag32,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id = 33) THEN 1 ELSE 0 END AS tmp_cflag33,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id = 34) THEN 1 ELSE 0 END AS tmp_cflag34,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id = 35) THEN 1 ELSE 0 END AS tmp_cflag35,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id = 36) THEN 1 ELSE 0 END AS tmp_cflag36,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id = 37) THEN 1 ELSE 0 END AS tmp_cflag37,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id = 38) THEN 1 ELSE 0 END AS tmp_cflag38,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id = 39) THEN 1 ELSE 0 END AS tmp_cflag39,
        CASE WHEN search_name = (SELECT api_search_word FROM :chaintbl WHERE chain_id = 40) THEN 1 ELSE 0 END AS tmp_cflag40
    FROM tmp1
),
